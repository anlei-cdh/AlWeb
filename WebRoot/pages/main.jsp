...
<html>
  ...
  <body>
  	...
  	<div class="content marginLeft marginTop">
  		<a href="pages/offline/offline.jsp" target="_blank">
  			<img src="pages/images/offline.png" width="256px" height="144px" alt="离线计算框架-Hive,MapReduce" />
  		</a>
  	</div>
  	<div class="content marginTop">
  		<a href="pages/stream/storm.jsp" target="_blank">
  			<img src="pages/images/storm.png" width="256px" height="144px" alt="流式计算框架-Storm" />
  		</a>
  	</div>
  	<div class="content marginTop">
  		<a href="pages/stream/streaming.jsp" target="_blank">
  			<img src="pages/images/streaming.png" width="256px" height="144px" alt="流式计算框架-Spark Streaming" />
  		</a>
  	</div>
  	<div class="content clear marginLeft">
  		<a href="pages/memory/memory.jsp" target="_blank">
  			<img src="pages/images/memory.png" width="256px" height="144px" alt="内存计算框架-Spark Core" />
  		</a>
  	</div>
  	<div class="content">
  		<a href="pages/interactive/interactive.jsp" target="_blank">
  			<img src="pages/images/interactive.png" width="256px" height="144px" alt="交互式查询-Impala,Kudu" />
  		</a>
  	</div>
  	<div class="content">
  		<a href="pages/classification/logisticregression.jsp" target="_blank">
  			<img src="pages/images/logisticregression.png" width="256px" height="144px" alt="分类算法-Logistic Regression" />
  		</a>
  	</div>
  	<div class="content clear marginLeft">
  		<a href="pages/classification/decisiontree.jsp" target="_blank">
  			<img src="pages/images/decisiontree.png" width="256px" height="144px" alt="分类算法-Decision Tree" />
  		</a>
  	</div>
  	<div class="content">
  		<a href="pages/clustering/clustering.jsp" target="_blank">
  			<img src="pages/images/clustering.png" width="256px" height="144px" alt="聚类算法-Kmeans" />
  		</a>
  	</div>
  	<div class="content">
  		<a href="pages/recommendation/recommendation.jsp" target="_blank">
  			<img src="pages/images/recommendation.png" width="256px" height="144px" alt="推荐算法-ALS" />
  		</a>
  	</div>
  	<script type="text/javascript">
  	var width = $(window).width();
  	var height = $(window).height();
  	var marginLeft = (width - (256 * 3) - ((36 + 10) * 2)) / 2;
  	var marginTop = (height - (144 * 3) - ((30 + 16) * 2)) / 2;
