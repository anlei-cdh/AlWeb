  ...
  <body>
  	...
  	<div class="content marginLeft marginTop">
  		<a href="pages/offline/offline.jsp" target="_blank">
  			<img src="pages/images/offline.png" width="320px" height="180px" alt="离线计算框架-Hive,MapReduce" />
  		</a>
  	</div>
  	<div class="content marginTop">
  		<a href="pages/stream/storm.jsp" target="_blank">
  			<img src="pages/images/storm.png" width="320px" height="180px" alt="流式计算框架-Storm" />
  		</a>
  	</div>
  	<div class="content marginTop">
  	...
  	<div class="content">
  		<a href="pages/interactive/interactive.jsp" target="_blank">
  			<img src="pages/images/interactive.png" width="320px" height="180px" alt="交互式查询-Impala,Kudu" />
  		</a>
  	</div>
  	...
  	var marginTop = (height - (180 * 2) + 30) / 3;
