...
<html>
  <head>
	...
	<script src="pages/react/react.min.js"></script>
    <script src="pages/react/react-dom.min.js"></script>
    <script src="pages/react/browser.min.js"></script>
  ...
  <body>
    ...
    function putdata(data,index) {
    	...
    	data.map(function(item) {
        	...
        	ReactDOM.render(<div>{name}</div>,document.getElementById('title' + index));
            var imgurl = "pages/recommendation/images/" + type + "/" + image;
            var imgwidth = "167px";
            if(index >= 5) {
              imgwidth = "212px";
            }
            ReactDOM.render(<img src={imgurl} width={imgwidth} />,document.getElementById('contentr' + index));
    ...
    function ajaxQuery() {
		...
		function initData(data,index) {
			...
			data.map(function(item) {
                ...
                ReactDOM.render(<img src={imgurl} width={imgwidth} />,document.getElementById('imgr' + index));
    ...
    <div data-am-widget="tabs" class="am-tabs am-tabs-default tabs-add">
      ...
      <div class="am-tabs-bd am-tabs-bd-add">
          <div id="imgr1" data-tab-panel-0 class="am-tab-panel am-active" style="padding: 3px 3px;">
          	<img id="img1" src="" width=214 />
          </div>
          <div id="imgr2" data-tab-panel-1 class="am-tab-panel" style="padding: 3px 3px;">
          	<img id="img2" src="" width=214 />
          </div>
          <div id="imgr3" data-tab-panel-2 class="am-tab-panel" style="padding: 3px 3px;">
            <img id="img3" src="" width=214 />
          </div>
          <div id="imgr4" data-tab-panel-3 class="am-tab-panel" style="padding: 3px 3px;">
          	<img id="img4" src="" width=214 />
          </div>
          <div id="imgr5" data-tab-panel-4 class="am-tab-panel" style="padding: 3px 3px;">
  ...
  <div class="am-panel am-panel-default am-panel-add am-panel-primary" style="margin-left: 50px;">
    <div id="title1" class="am-panel-hd am-panel-title-add">推荐电影1</div>
  	  <div id="contentr1" class="am-panel-bd am-panel-content-add">
  ...
  <div class="am-panel am-panel-default am-panel-add am-panel-primary">
    <div id="title2" class="am-panel-hd am-panel-title-add">推荐电影2</div>
  	  <div id="contentr2" class="am-panel-bd am-panel-content-add">
  ...
  <div class="am-panel am-panel-default am-panel-add am-panel-primary">
    <div id="title3" class="am-panel-hd am-panel-title-add">推荐电影3</div>
  	  <div id="contentr3" class="am-panel-bd am-panel-content-add">
  ...
  <div class="am-panel am-panel-default am-panel-add am-panel-primary">
    <div id="title4" class="am-panel-hd am-panel-title-add">推荐电影4</div>
  	  <div id="contentr4" class="am-panel-bd am-panel-content-add">
  ...
  <div data-am-widget="tabs" class="am-tabs am-tabs-default tabs-add2">
      ...
      <div class="am-tabs-bd am-tabs-bd-add">
          <div id="imgr6" data-tab-panel-0 class="am-tab-panel am-active" style="padding: 3px 16px;">
          	<img id="img6" src="" width=186 />
          </div>
          <div id="imgr7" data-tab-panel-1 class="am-tab-panel" style="padding: 3px 16px;">
          	<img id="img7" src="" width=186 />
          </div>
          <div id="imgr8" data-tab-panel-2 class="am-tab-panel" style="padding: 3px 16px;">
            <img id="img8" src="" width=186 />
          </div>
          <div id="imgr9" data-tab-panel-3 class="am-tab-panel" style="padding: 3px 16px;">
          	<img id="img9" src="" width=186 />
          </div>
          <div id="imgr10" data-tab-panel-4 class="am-tab-panel" style="padding: 3px 16px;">
  ...
  <div class="am-panel am-panel-default am-panel-add2 am-panel-primary" style="margin-left: 50px;">
    <div id="title5" class="am-panel-hd am-panel-title-add2">推荐用户1</div>
  	  <div id="contentr5" class="am-panel-bd am-panel-content-add2">
  ...
  <div class="am-panel am-panel-default am-panel-add2 am-panel-primary">
    <div id="title6" class="am-panel-hd am-panel-title-add2">推荐用户2</div>
  	  <div id="contentr6" class="am-panel-bd am-panel-content-add2">
  ...
  <div class="am-panel am-panel-default am-panel-add2 am-panel-primary">
    <div id="title7" class="am-panel-hd am-panel-title-add2">推荐用户3</div>
  	  <div id="contentr7" class="am-panel-bd am-panel-content-add2">
  ...
  <div class="am-panel am-panel-default am-panel-add2 am-panel-primary">
    <div id="title8" class="am-panel-hd am-panel-title-add2">推荐用户4</div>
  	  <div id="contentr8" class="am-panel-bd am-panel-content-add2">
